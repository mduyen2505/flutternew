...
Future<List<CartItem>> getCart(String userId) async {
  ...
  Future<void> addToCart(String userId, String productId, int quantity) async {
    ...
    _logger.e('Error deleting product: ${responseData['message'] ?? 'Unknown error'}');
  ...
  final url = Uri.parse('${Config.baseUrl}/cart/delete-product-cart/$userId/product/$productId');
  ...
  final url = Uri.parse('${Config.baseUrl}/cart/$userId/$productId');
