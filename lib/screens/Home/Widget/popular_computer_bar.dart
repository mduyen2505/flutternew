...
class PopularComputerBar extends StatefulWidget {
  final bool isRefreshing; // Add this line

  const PopularComputerBar({super.key, this.isRefreshing = false}); // Update constructor
...
class _PopularComputerBarState extends State<PopularComputerBar> {
  ...
  void initState() {
    super.initState();
    futureComputers = loadComputers(); // Load computers from model
  }
